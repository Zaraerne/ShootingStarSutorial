...
public class ScoringUIController : MonoBehaviour
{
    ...
    [SerializeField] Transform highScoreLeaderboardCotainer;
    ...
    void ShowScoringScreen()
    {
        ...
        playerScoreText.text = ScoreManager.Instance.Sorce.ToString();
    ...
    void UpdateHighScoreLeaderboard()
    {
        ...
        for(int i=0;i<highScoreLeaderboardCotainer.childCount;i++)
        {
            var child = highScoreLeaderboardCotainer.GetChild(i);
